...
class personal_details(BaseModel):
    ...
    postion: Optional[str] = Field(
        description="Position of the user, CEO , CTO, CIO, Founder or if others please specify")


class general_problem_identification(BaseModel):
...
''')
    skill_rating: Optional[int] = Field(
        description="Rating of the problem on a scale of 1 to 5 where 1 is the least and 5 is the most")
...
''')
    staff_rating: Optional[int] = Field(
        description="Rating of the problem on a scale of 1 to 5 where 1 is the least and 5 is the most")
...
''')
    structuring_rating: Optional[int] = Field(
        description="Rating of the problem on a scale of 1 to 5 where 1 is the least and 5 is the most")
...
''')
    strategies_rating: Optional[int] = Field(
        description="Rating of the problem on a scale of 1 to 5 where 1 is the least and 5 is the most")
    additional_comments: Optional[str] = Field(
        description="Any additional comments")


class ceo_survey(BaseModel):
...
• Responding effectively to competitive AI-driven RFPs/RFQs''')
    strategic_leadership_rating: Optional[int] = Field(
        description="Rating of the problem on a scale of 1 to 5 where 1 is the least and 5 is the most")
...
• Mitigating risks if key AI personnel leave''')
    talent_management_rating: Optional[int] = Field(
        description="Rating of the problem on a scale of 1 to 5 where 1 is the least and 5 is the most")
    operatinal_excellence: Optional[str] = Field(description='''• Establishing a clear and actionable AI strategy
...
• Providing regular training and scenario planning for AI-related challenges''')
    operatinal_excellence_rating: Optional[int] = Field(
        description="Rating of the problem on a scale of 1 to 5 where 1 is the least and 5 is the most")
...
• Demonstrating the unique value of AI to avoid commoditization''')
    competitive_advantage_rating: Optional[int] = Field(
        description="Rating of the problem on a scale of 1 to 5 where 1 is the least and 5 is the most")
    additional_comments: Optional[str] = Field(
        description="Any additional comments")


class cio_or_cto_survey(BaseModel):
...
• Maintaining rigorous testing and validation for AI solutions''')
    technical_strategy_rating: Optional[int] = Field(
        description="Rating of the problem on a scale of 1 to 5 where 1 is the least and 5 is the most")
...
• Managing contingencies for the potential departure of key AI personnel''')
    talent_resource_and_management_rating: Optional[int] = Field(
        description="Rating of the problem on a scale of 1 to 5 where 1 is the least and 5 is the most")
    process_and_system_effciency: Optional[str] = Field(description='''• Defining a comprehensive AI strategy with detailed action plans
...
• Ensuring regular and detailed training for AI-related scenarios''')
    process_and_system_effciency_rating: Optional[int] = Field(
        description="Rating of the problem on a scale of 1 to 5 where 1 is the least and 5 is the most")
    innovation_and_diffrentiation: Optional[str] = Field(description='''• Creating a precise AI adoption roadmap aligned with IT objectives
...
''')
    innovation_and_diffrentiation_rating: Optional[int] = Field(
        description="Rating of the problem on a scale of 1 to 5 where 1 is the least and 5 is the most")
    additional_comments: Optional[str] = Field(
        description="Any additional comments")


class founder_survey(BaseModel):
...
• Responding effectively to AI-related RFPs/RFQs to maintain competitive edge''')
    strategic_clarity_and_alignment_rating: Optional[int] = Field(
        description="Rating of the problem on a scale of 1 to 5 where 1 is the least and 5 is the most")
...
• Managing the risk if key AI personnel leave, ensuring continuity''')
    building_and_nurturing_talent_rating: Optional[int] = Field(
        description="Rating of the problem on a scale of 1 to 5 where 1 is the least and 5 is the most")
    process_optimization_and_efficiency: Optional[str] = Field(
        description='''• Establishing a clear, principled AI strategy
• Defining accountability and ownership for AI initiatives
...
• Ensuring regular and comprehensive training for AI-related scenarios''')
    process_optimization_and_efficiency_rating: Optional[int] = Field(
        description="Rating of the problem on a scale of 1 to 5 where 1 is the least and 5 is the most")
    competitive_differentiation_and_growth: Optional[str] = Field(
        description='''• Creating a detailed AI adoption roadmap that aligns with our long-term vision
...
• Demonstrating the unique value of our AI solutions to prevent commoditization''')
    competitive_differentiation_and_growth_rating: Optional[int] = Field(
        description="Rating of the problem on a scale of 1 to 5 where 1 is the least and 5 is the most")
    additional_comments: Optional[str] = Field(
        description="Any additional comments")
